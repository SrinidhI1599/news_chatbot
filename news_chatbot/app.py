...
st.markdown("""
Welcome to the **AI-Powered News Chatbot** 🤖📰  

This chatbot fetches the latest news from Google News and uses advanced AI to provide:
- 📌 News summaries  
- 📊 Insights and explanations  
- ❓ Answers to your news-related questions  

Simply type your query below to explore real-time news intelligently.
""")
